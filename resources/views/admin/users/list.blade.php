                                        ...
                                        <ul class="icons-list">
                                            <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right">
                                                    <li><a href="{{url('admin/users/edit')}}/{{$tk->id}}"><i class="icon-file-pdf"></i> Chỉnh sửa</a></li>
                                                    <li><a href="{{url('admin/users/del/')}}/{{$tk->id}}" onclick="return confirm('Bạn có muốn xóa tài khoản này không?');"><i class="icon-file-excel"></i> Xóa</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </td>
