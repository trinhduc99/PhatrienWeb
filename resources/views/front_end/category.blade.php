                ...
                <div class="col-md-4 col-sm-6">
                    <div class="room-item">
                        ...
                        <div class="room-detail">
                            <h4><a href="phongtro/{{ $room->ac_title_slug }}">{{ $room->acc_title }}</a></h4>
                            <div class="room-meta">
                            ...
                            <div class="room-description"><i class="fas fa-audio-description"></i>
                                {!! substr($room->acc_description, 0, 33) . '...' !!}</div>
                            <div class="room-info">
                                <span><i class="far fa-stop-circle"></i> Diện tích: <b>{{ $room->acc_area }} m<sup>2</sup></b></span>
