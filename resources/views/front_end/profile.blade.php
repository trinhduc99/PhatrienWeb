                ...
                <div class="banner-info mb-5">
                    <div class="mapInfo false" style="" data-reactid="47">
                        @if($user->avatar == 'no-avatar.jpg')
                            <img
                                style="color:#ffffff;background-color:rgb(188, 188, 188);user-select:none;display:inline-flex;align-items:center;justify-content:center;font-size:40px;border-radius:50%;height:80px;width:80px;"
                                alt="Thành Trung" size="80" src="images/no-avatar.jpg" class="avatar" data-reactid="57">
                        @else
                            <img
                                style="color:#ffffff;background-color:rgb(188, 188, 188);user-select:none;display:inline-flex;align-items:center;justify-content:center;font-size:40px;border-radius:50%;height:80px;width:80px;"
                        ...
                        <a href="{{route('profile.edit')}}">
                            <div
                                ...
                                <button tabindex="0" type="button"
                                    ...
                                    <div>
                                        <div
                                            style="transition: all 450ms cubic-bezier(0.23, 1, 0.32, 1) 0ms; top: 0px;">
                ...
                <div class="mypage">
                    ...
                    <div class="mainpage">
                        @if( count($mypost) < 1)
                            ...
                            <a href="{{route('post.index')}}" class="btn-post">ĐĂNG TIN</a>
                        @else
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    @foreach($mypost as $post)
                                        <tr>
                                            <td> <a href="phongtro/{{ $post->ac_title_slug }}">{{ $post->acc_title }}</a></td>
                                            <td>{{ $post->category->name}}</td>
                                            <td>{{ $post->acc_price }}</td>
                                            ...
                                            <td>
                                                <a href="phongtro/{{ $post->ac_title_slug }}"><i
                                                        class="fas fa-eye"></i> Xem</a>
                                                @if($post->approve === 0)
                                                <a href="{{route('post.edit',['id' => $post->id])}}"><i
