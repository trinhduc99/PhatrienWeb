            ...
            <div class="col-md-8">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        @if($user->status !=0)
                            <form action="{{ route ('post.create') }}" method="POST" id="form_dangtin" enctype="multipart/form-data" >
                                @csrf
                                <div class="form-group">
                                    <label for="usr">Tiêu đề bài đăng:</label>
                                    <input type="text" id="usr" class="form-control" name="acc_title" value="{{old('acc_title')}}">
                                </div>
                                <div class="form-group">
                                    <label for="location-text-box">Địa chỉ phòng trọ:</label> Bạn có thể nhập hoặc chọn ví trí trên bản đồ
                                    <input type="text" id="location-text-box" name="acc_address" class="form-control" value="{{old('acc_address')}}" />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number"  name="acc_price" value="{{old('acc_price')}}"  class="form-control" placeholder="750000" >
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="usr">Diện tích( m<sup>2</sup>):</label>
                                            <input type="number" name="acc_area" class="form-control" value="{{old('acc_area')}}" placeholder="16">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
...
{{--                                    </div>--}}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" name="acc_description" data-value="{{old('acc_description')}}" style=" resize: none;"></textarea>
                                </div>
                                <div class="form-group">
            ...
            <div class="col-md-4">
                ...
                <div class="gap"></div>
{{--                <img src="{{asset('images/banner-1.png')}}" width="100%">--}}
            </div>
        </div>
    </div>
